...
{
public:
  LocalViewScene(int vt_window_width_in, int vt_window_height_in, LocalViewMatch *in_vt)
  {

    vt_window_width = vt_window_width_in;
    vt_window_height = vt_window_height_in;
