...
# --rate 1.0 --clock --start-paused --topics /stereo_camera/left/image_raw /odometry/filtered 
# --remap /odometry/filtered:=/robotarium/odom /stereo_camera/left/image_raw:=/robotarium/camera/image/image_raw
...
def generate_launch_description():
    ...
    # Configuration file
    config_file = os.path.join(pkg_dir, 'config', 'config_robotarium.yaml')
